                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <AdminFormField label={`Posun X (${data.homeDecorations.hero.offsetX}px)`} htmlFor="hero-offset-x">
                                            <input
                                                type="range"
                                                id="hero-offset-x"
                                                min={-200}
                                        ...
                                        <AdminFormField label={`Posun Y (${data.homeDecorations.hero.offsetY}px)`} htmlFor="hero-offset-y">
                                            <input
                                                type="range"
                                                id="hero-offset-y"
                                                min={-200}
